...
namespace EvolutionAutomationTests
{
	...
	public class InstitucionesEductivas
	{
        ...
        public void Eliminar_Institución_Educativa()
        {
            ...
            //Verificaciones
            IWebElement lblRegistros = wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id='smlInstitucionesEducativas_grid']/div[4]/span[2]")));
