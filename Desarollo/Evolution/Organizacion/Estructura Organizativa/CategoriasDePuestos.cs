...
namespace EvolutionAutomationTests
{
    ...
    public class CategoriasDePuesto
    {
        ...
        public void Crear_Categoria_De_Puesto()
        {
            ...
            txtBuscar.SendKeys(Keys.Enter);
            IWebElement btnBuscar = driver.FindElement(By.Id("smlCategorias_btQuickSearch"));
            btnBuscar.Click();
        ...
        public void Eliminar_Categoria_De_Puesto()
        {
            ...
            //Verificaciones
            IWebElement lblRegistros = wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id='smlCategorias_grid']/div[4]/span[2]")));
